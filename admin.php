...
?>
		...
		<li>
		<!-- 하단의 수정 버튼을 클릭하면 파일에서 사용자가 수정한 레벨과 포인트를 전달받아 DB를 업데이트 -->
		<form method="post" action="admin_member_update.php?num=<?=$num?>">
			...
			<!-- 수정 버튼을 클릭하면 admin_member_update.php 파일로 이동 -->
			<span class="col7"><button type="submit">수정</button></span>

			<!-- 삭제 버튼을 클릭하면 admin_member_delete.php 파일로 이동-->
			<span class="col8">
...
?>
		<li>
			<!-- admin_board_delete.php 파일에서 어던 체크박스를 선택했는지 검사하여 해당 레코드 삭제 -->
			<!-- 체크박스의 name 속성을 item[]으로 설정 -->
...
<?php
   ...
   mysqli_close($con);
?>
				<!-- 버튼 클릭시 액션에서 연결한 admin_board_delete.php로 이동 -->
