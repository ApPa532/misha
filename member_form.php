...
<script>
   function check_input()
   {
      if (!document.member_form.id.value.trim()) { 
      	//회원가입 페이지에 사용자가 아이디를 입력하지 않았다면. trim()은 문자열 좌우에 공백 제거하는 함수.
      ...
      if (!document.member_form.pass.value.trim()) { 
          alert("비밀번호를 입력하세요!");    
          document.member_form.pass.focus(); //focus는 아무것도 입력하지 않았다면 비어있는 입력칸에 포커스가 맞춰지도록 해준다.
          return;
      }
          	...
          	<form  name="member_form" method="post" action="member_insert.php">
                ...
                <div class="form">
                   ...
                   <div class="form id">
                    ...
                    <div class="col3">
                        <a href="#"><img src="./img/check_id.png" onclick="check_id()" ></a>
