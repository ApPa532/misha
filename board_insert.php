...
<?php
	...
	//실습 사이트의 게시판에 글을 쓰려면 로그인 되어 있어야 함.
	...
	$regist_day = date("Y-m-d (H:i)");  //글을 작성한 현재 년/월/일/시/분을 저장
	...
	if ($upfile_name && !$upfile_error)
	{
		...
		//move_uploaded_file() 함수를 이용해 서버에 임시 저장된 $upfile_tmp_name 파일을 $uploaded_file의 값인 경로/파일명 형태로 저장되도록 함
	...
	//포인트 부여하기. 게시판에 글 작성 시 회원에게 포인트 100점씩 부여
	$point_up = 100;
	...
	/* location.href에 board_list.php를 설정하여 목록 페이지로 이동하도록 함 */
	echo "
		<script>
